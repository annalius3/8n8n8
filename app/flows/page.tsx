  ...
  try {
    ...
    return (
      <div className="space-y-6">
        <Card>
          <CardHeader>
            <CardTitle>Потоки временно недоступны</CardTitle>
            <p className="text-sm text-muted-foreground">
              Приложение не смогло загрузить данные из production-базы. Проверьте `DATABASE_URL`, выполните `prisma migrate deploy`
              и перезапустите deployment.
            </p>
          </CardHeader>
          <CardContent className="flex flex-wrap gap-2">
            <LinkButton href="/login">Войти заново</LinkButton>
            <LinkButton href="/settings" variant="outline">Настройки</LinkButton>
